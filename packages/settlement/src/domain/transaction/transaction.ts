...
export class Transaction {
  ...
  /** Orphan PENDING (no real provider charge / stale claim) → Expired. */
  expireUncharged(): Transaction {
  ...
  /**
   * Approved charge that could not decrement stock → Error.
   * Requires a real provider transaction id (not a claim).
   */
  markSettlementError(): Transaction {
